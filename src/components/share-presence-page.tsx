...
export function SharePresencePage({ quietMode }: SharePresencePageProps) {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white ${quietMode ? 'pt-0' : 'pt-24'}`}>
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-purple-500/20 to-pink-500/20 border border-purple-500/30 mb-8"
          >
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-white/10 rounded-3xl p-8 md:p-12 mb-12"
        >
          <div className="space-y-6 mb-10">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg mb-2 text-white">Your Voice Matters</h3>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg mb-2 text-white">What We're Asking</h3>
                <p className="text-slate-300 leading-relaxed">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="text-lg mb-2 text-white">A Quiet Approach</h3>
                <p className="text-slate-300 leading-relaxed">
          ...
          <div className="text-center">
            <Button
              ...
              size="lg"
              className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-8 py-6 text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
            >
